package com.xwplay.crm.common.response;
...
public class JsonResult extends LinkedHashMap<String, Object> implements Serializable {
    ...
    public static JsonResult data(Object data) {
        return new JsonResult(true,CODE_SUCCESS, "ok",data);
    }
    ...
    // 构建指定状态码
    public static JsonResult get(boolean success,int code, String msg, Object data) {
